...
{
    public class SQLServerXRepository<TEntity, TKey> : ISQLRepository<TEntity, TKey> where TEntity : class, IEntity<TKey>
    {
        private readonly TypedClient<TEntity, SqlConnection, TKey> _typedClient;
        public SQLServerXRepository(SQLServerDbContext context)
        {
